...
def crop_background(image: np.ndarray, mask: Optional[np.ndarray] = None, 
                   threshold: float = 0, margin: int = 10) -> Tuple[np.ndarray, Optional[np.ndarray], Dict]:
    """
...
def resample_image(image: np.ndarray, target_size: Tuple[int, int], 
                   method: str = 'bilinear', mask: Optional[np.ndarray] = None,
                   mask_interpolation: str = 'linear', resize_mode: str = 'resize_only') -> Tuple[np.ndarray, Optional[np.ndarray]]:
    """
...
def normalize_intensity(image: np.ndarray, method: str = 'min_max', 
...
def permute_axes(image: np.ndarray, source_order: str = 'HWC', 
...
def preprocess_pipeline(image: np.ndarray, mask: Optional[np.ndarray] = None,
                       config: Optional[Dict] = None) -> Tuple[np.ndarray, Optional[np.ndarray], Dict]:
    """
...
def batch_preprocess(images: list, masks: Optional[list] = None, 
                    config: Optional[Dict] = None) -> Tuple[list, Optional[list], list]:
    """
