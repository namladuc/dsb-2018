...
def test_debug_preprocessing_output() -> None:
    ...
    assert os.path.exists(
        os.path.join(debug_path, "train", "before_preprocess")
    ), "Before preprocess folder not created"
    assert os.path.exists(
        os.path.join(debug_path, "train", "after_preprocess")
    ), "After preprocess folder not created"
    assert os.path.exists(
        os.path.join(debug_path, "train", "masks_before")
    ), "Masks before folder not created"
    assert os.path.exists(
        os.path.join(debug_path, "train", "masks_after")
    ), "Masks after folder not created"
